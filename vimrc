...
function Spectacle() range
  let v = s:get_visual_selection()
  echo system("spectacle -b -r -o" . v . "> /dev/null")
endfunction

vnoremap <leader>sc :call Spectacle()<CR>

"------------------ Pandoc -----------------------
nnoremap <leader>pd :Pandoc -s -c ~/templates/pandoc.css --toc
